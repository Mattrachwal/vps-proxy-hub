...
#!/bin/bash
# Helper script to add a peer public key

if [[ $# -ne 2 ]]; then
    echo "Usage: $0 <peer-name> <public-key>"
    echo "Example: $0 home-1 'ABC123...='"
    exit 1
fi
...
echo "Added public key for peer: $PEER_NAME"
echo "Regenerating WireGuard configuration..."

# Regenerate configuration
cd /opt/vps-proxy-hub/vps/scripts || cd /root/vps-proxy-hub/vps/scripts
